...
mod implementation {
    ...
    impl DeriveKey for Rsa2048Pkcs {
        #[inline(never)]
        fn derive_key(
    ...
    #[cfg(feature = "rsa2048")]
    impl DeserializeKey for Rsa2048Pkcs {
        #[inline(never)]
        fn deserialize_key(
            keystore: &mut impl Keystore,
    ...
    #[cfg(feature = "rsa2048")]
    impl GenerateKey for Rsa2048Pkcs {
        #[inline(never)]
        fn generate_key(
            keystore: &mut impl Keystore,
    ...
    #[cfg(feature = "rsa2048")]
    impl SerializeKey for Rsa2048Pkcs {
        #[inline(never)]
        fn serialize_key(
            keystore: &mut impl Keystore,
    ...
    impl Exists for Rsa2048Pkcs {
        ...
        fn exists(
            ...
            let exists =
                keystore.exists_key(key::Secrecy::Secret, Some(key::Kind::Rsa2048), &key_id);
            Ok(reply::Exists { exists })
        }
    }

    #[cfg(feature = "rsa2048")]
    impl Sign for Rsa2048Pkcs {
        #[inline(never)]
        fn sign(
            keystore: &mut impl Keystore,
    ...
    #[cfg(feature = "rsa2048")]
    impl UnsafeInjectKey for Rsa2048Pkcs {
        #[inline(never)]
